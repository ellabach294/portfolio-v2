            ...
            <Layout className="pt-16">
                ...
                <div className='grid w-full grid-cols-8 gap-16'>
                    <div className='col-span-6 xl:col-span-8 flex flex-col items-start justify-start mx-20 mt-10'>
                        ...
                        <p className='my-4 font-medium text-lg lg:text-base'>Moved to Vancouver in 2017 and continues my career path in the hospitality industry, I registered for the post-graduate diploma in Hospitality Marketing. However, the challenges of the COVID-19 pandemic brough unexpected barriers for job hunting in Vancouver, and it motivated me to shift my focus. As a person who loves to learn new things and explore different path, I began self-learning design and coding, create a WordPress site to selling my DIY Supplies, Figure Toys, and Custom Stickers. Inspired by the that process, I enrolled in NAIT&apos;s Web Design and Development to deepen my technological skills.</p>
                        <p className='font-medium text-lg lg:text-base'>Join me on this exciting journey in coding, where each project brings fresh ideas to life. Let&apos;s innovate together and create something extraordinary! </p>
